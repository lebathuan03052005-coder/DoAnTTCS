...
const MOCK_MENU = [
  {
    id: 1, category_id: 1, item_name: "Gỏi cuốn tôm thịt",
    description: "Gỏi cuốn tươi ngon với tôm, thịt heo, bún, rau thơm, chấm tương hoisin đặc biệt.",
    price: 85000, image_url: "", is_best_seller: true,
    ingredients: "Tôm, thịt heo, bún tươi, xà lách, húng quế, bánh tráng",
    allergy_warnings: "Hải sản, gluten", is_spicy: false, is_vegetarian: false, serving_size: "2 cuốn"
  },
  {
    id: 2, category_id: 1, item_name: "Chả giò hải sản",
    description: "Chả giò giòn rụm nhân hải sản, cà rốt, mộc nhĩ, miến thủy tinh.",
    price: 95000, image_url: "", is_best_seller: false,
    ingredients: "Tôm, mực, cá, cà rốt, mộc nhĩ, miến", allergy_warnings: "Hải sản, gluten",
    is_spicy: false, is_vegetarian: false, serving_size: "4 chiếc"
  },
  {
    id: 3, category_id: 2, item_name: "Bò bít tết sốt tiêu đen",
    description: "Thăn bò Mỹ 200g áp chảo vừa chín, sốt tiêu đen đậm đà, khoai tây chiên và rau củ nướng.",
    price: 320000, image_url: "", is_best_seller: true,
    ingredients: "Thăn bò Mỹ, tiêu đen, khoai tây, cà rốt, đậu hà lan",
    allergy_warnings: "Sữa", is_spicy: true, is_vegetarian: false, serving_size: "200g"
  },
  {
    id: 4, category_id: 2, item_name: "Sườn heo nướng BBQ",
    description: "Sườn heo non ướp 24h với sốt BBQ đặc chế, nướng chậm lửa than hoa, thơm lừng mềm tan.",
    price: 280000, image_url: "", is_best_seller: true,
    ingredients: "Sườn heo, sốt BBQ, mật ong, tỏi, gia vị đặc biệt",
    allergy_warnings: "Không có", is_spicy: false, is_vegetarian: false, serving_size: "350g"
  },
  {
    id: 5, category_id: 3, item_name: "Tôm hùm nướng bơ tỏi",
    description: "Tôm hùm Canada tươi sống 600g, nướng với bơ tỏi pháp và thảo mộc tươi.",
    price: 980000, image_url: "", is_best_seller: true,
    ingredients: "Tôm hùm Canada, bơ Pháp, tỏi, thảo mộc, chanh",
    allergy_warnings: "Hải sản, sữa", is_spicy: false, is_vegetarian: false, serving_size: "600g"
  },
  {
    id: 6, category_id: 3, item_name: "Cá hồi sốt chanh leo",
    description: "Phi lê cá hồi Na Uy áp chảo vàng giòn, sốt chanh leo nhiệt đới thanh chua dịu.",
    price: 420000, image_url: "", is_best_seller: false,
    ingredients: "Cá hồi Na Uy, chanh leo, cream, cà pháo, rau mùi",
    allergy_warnings: "Hải sản, sữa", is_spicy: false, is_vegetarian: false, serving_size: "180g"
  },
  {
    id: 7, category_id: 4, item_name: "Crème brûlée vani Madagascar",
    description: "Bánh flan kem vani Madagascar cổ điển, mặt đường caramel giòn tan, trang trí quả mọng tươi.",
    price: 95000, image_url: "", is_best_seller: false,
    ingredients: "Kem, trứng, vani Madagascar, đường, quả mọng",
    allergy_warnings: "Trứng, sữa", is_spicy: false, is_vegetarian: true, serving_size: "120ml"
  },
  {
    id: 8, category_id: 4, item_name: "Bánh chocolate fondant",
    description: "Bánh chocolate ấm chảy bên trong, kem vanilla bên cạnh, rắc bột cacao Bỉ.",
    price: 110000, image_url: "", is_best_seller: true,
    ingredients: "Chocolate 70%, bơ, trứng, bột mì, kem vanilla",
    allergy_warnings: "Trứng, sữa, gluten", is_spicy: false, is_vegetarian: true, serving_size: "1 cái"
  },
  {
    id: 9, category_id: 5, item_name: "Rượu vang đỏ Pháp",
    description: "Château Margaux 2018, mượt mà, hương cherry đen, tanin tinh tế, hậu vị kéo dài.",
    price: 350000, image_url: "", is_best_seller: false,
    ingredients: "Nho Cabernet Sauvignon, Merlot", allergy_warnings: "Sulfite",
    is_spicy: false, is_vegetarian: true, serving_size: "150ml"
  },
  {
    id: 10, category_id: 5, item_name: "Cocktail The King Special",
    description: "Cocktail signature của nhà hàng: vodka, passion fruit, lychee, bạc hà tươi và soda.",
    price: 150000, image_url: "", is_best_seller: true,
    ingredients: "Vodka, passion fruit, vải, bạc hà, soda, đá",
    allergy_warnings: "Cồn", is_spicy: false, is_vegetarian: true, serving_size: "250ml"
  },
];
...
// ─── Component: Badge ────────────────────────────────────────────────────────
const Badge = ({ label, type }) => <span className={`badge badge--${type}`}>{label}</span>;

// ─── Component: MenuCard ─────────────────────────────────────────────────────
const MenuCard = ({ item, onClick }) => (
  <article className="menu-card" onClick={() => onClick(item)} role="button" tabIndex={0}
    onKeyDown={(e) => e.key === "Enter" && onClick(item)}>
    <div className="menu-card__image-wrap">
      {item.image_url
        ? <img src={item.image_url} alt={item.item_name} className="menu-card__image" />
        : <div className="menu-card__image-placeholder">{CATEGORY_EMOJI[item.category_id] || "🍽️"}</div>
      }
      ...
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal__image-wrap">
          {item.image_url
            ...
            : <div className="modal__image-placeholder">{CATEGORY_EMOJI[item.category_id] || "🍽️"}</div>
          }
        </div>
  ...
  return (
    <div className="menu-page">
      ...
      <header className="menu-header">
        <div className="menu-header__crown">♛</div>
        <h1 className="menu-header__title">THE KING</h1>
        <p className="menu-header__sub">RESTAURANT & FINE DINING</p>
        <div className="menu-header__divider"><span>✦</span></div>
      </header>
